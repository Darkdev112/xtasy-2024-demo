    ...
    return(
        <section>
          ...
          <div className="md:min-h-[calc(100vh-112px-170px)] sm:min-h-[calc(100vh-112px-90px)] flex flex-col md:px-[100px] sm:px-5">
            <p className="h-1/6 max-w-max font-gilroy font-bold md:text-[24px] sm:text-[20px] text-[#E7D60A] tracking-wider underline md:underline-offset-[10px] sm:underline-offset-[8px]">To win a free Xtasy Merch, complete these task and mention us on Instagram</p>
            ...
            <p className="h-1/6 font-gilroy font-bold md:text-[18px] sm:text-[16px] text-[#B59AFF] tracking-wider">Answer these few question, and post it as instagram story mentioning “xtasy.outr” and stand a chance of winning the Xtasy merch!</p>
          </div>
